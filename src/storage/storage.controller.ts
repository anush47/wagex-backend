...
export class StorageController {
  ...
  async getSignedUrl(@Query('key') key: string, @Request() req: RequestWithUserNamespace.RequestWithUser) {
  ...
  async deleteFile(@Query('key') key: string, @Request() req: RequestWithUserNamespace.RequestWithUser) {
    if (!key) throw new BadRequestException('Key is required');
