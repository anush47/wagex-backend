...
export class CompaniesController {
  ...
  async create(@Body() createCompanyDto: CreateCompanyDto, @Request() req: RequestWithUserNamespace.RequestWithUser) {
    const user = req.user;
  ...
  async findAll(@Request() req: RequestWithUserNamespace.RequestWithUser, @Query() queryDto: QueryDto) {
    const user = req.user;
