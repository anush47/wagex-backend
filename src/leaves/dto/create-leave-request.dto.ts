...
export class CreateLeaveRequestDto {
  ...
  @ApiProperty({
    ...
    description: 'For Full/Half: date only. For Short Leave: include time (e.g., 2025-02-10T10:30:00Z)',
  })
  @IsDateString()
  startDate: string;
  ...
  @ApiProperty({
    ...
    description: 'For Full/Half: date only. For Short Leave: include time (e.g., 2025-02-10T12:00:00Z)',
  })
  @IsDateString()
  endDate: string;
