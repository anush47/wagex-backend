  ...
  private async calculateEarnedLeave(
    ...
    const holidays = await this.prisma.holiday.findMany({
      where: {
        ...
        OR: [
          leaveType.earnedOnHolidayCategories.includes(HolidayEarnCategory.PUBLIC) ? { isPublic: true } : null,
          leaveType.earnedOnHolidayCategories.includes(HolidayEarnCategory.MERCANTILE) ? { isMercantile: true } : null,
          leaveType.earnedOnHolidayCategories.includes(HolidayEarnCategory.BANK) ? { isBank: true } : null,
