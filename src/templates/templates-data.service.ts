...
export class TemplatesDataService {
  ...
  private async getEpfFormData(epfRecordId: string) {
    ...
    return {
      ...
      year: record.year,
      monthYear,
      periodStartDate: firstSal ? format(new Date(firstSal.periodStartDate), 'yyyy-MM-dd') : '',
      periodEndDate: firstSal ? format(new Date(firstSal.periodEndDate), 'yyyy-MM-dd') : '',
      epfRecord: record,
      salaries,
      totals,
  ...
  private async getEtfFormData(etfRecordId: string) {
    ...
    return {
      ...
      year: record.year,
      monthYear,
      periodStartDate: firstEtfSal ? format(new Date(firstEtfSal.periodStartDate), 'yyyy-MM-dd') : '',
      periodEndDate: firstEtfSal ? format(new Date(firstEtfSal.periodEndDate), 'yyyy-MM-dd') : '',
      etfRecord: record,
      salaries,
      totals,
      etfPercentage,
