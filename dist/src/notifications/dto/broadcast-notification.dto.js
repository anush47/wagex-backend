...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: client_1.Role, description: 'Target audience role', required: false }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ type: [String], required: false, description: 'Specific user IDs to target (validated against permissions)' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, enum: ['INFO', 'SUCCESS', 'WARNING', 'ERROR'], default: 'INFO' }),
    (0, class_validator_1.IsOptional)(),
