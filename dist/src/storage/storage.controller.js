    ...
    async getSignedUrl(key, req) {
        ...
        if (user.role !== client_1.Role.ADMIN) {
            ...
            if (user.role === client_1.Role.EMPLOYEE) {
                if (!storage_constants_1.ALLOWED_EMPLOYEE_FOLDERS.includes(resourceFolder)) {
                    throw new common_1.ForbiddenException('You do not have permission to access private files.');
                }
            }
        }
        return {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get signed URL' }),
