...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a policy. INFO: You must provide "companyId" in the body for permission validation.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get the default policy for a company' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.EMPLOYER, client_1.Role.EMPLOYEE),
    (0, permissions_decorator_1.Permissions)(permissions_1.Permission.VIEW_COMPANY),
    (0, swagger_1.ApiOperation)({ summary: 'Get the effective policy with source details (Effective, Company, Override)' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.EMPLOYER),
    (0, permissions_decorator_1.Permissions)(permissions_1.Permission.MANAGE_COMPANY),
    (0, swagger_1.ApiOperation)({ summary: 'Update a policy (Requires companyId in query)' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.EMPLOYER),
    (0, permissions_decorator_1.Permissions)(permissions_1.Permission.MANAGE_COMPANY),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a policy by ID (Requires companyId in query)' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Query)('companyId')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.EMPLOYER),
    (0, permissions_decorator_1.Permissions)(permissions_1.Permission.MANAGE_COMPANY),
    (0, swagger_1.ApiOperation)({ summary: 'Remove an override policy for an employee (Requires companyId in query)' }),
    __param(0, (0, common_1.Param)('employeeId')),
    __param(1, (0, common_1.Query)('companyId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
